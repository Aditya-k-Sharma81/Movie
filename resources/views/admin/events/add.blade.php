...
<div class="p-4 md:p-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 md:mb-8 gap-4">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-white">Add New Event</h1>
                <p class="text-sm text-slate-400">Enter event details to list it in your venue.</p>
            </div>
            <a href="/admin/dashboard" class="glass px-4 py-2 rounded-xl text-xs sm:text-sm hover:bg-slate-800 transition-all text-center">
        ...
        <div class="glass rounded-3xl p-5 sm:p-8">
            <form id="addEventForm" enctype="multipart/form-data" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <!-- Event Title -->
                <div class="sm:col-span-2">
                    <label class="block text-xs font-medium text-slate-500 uppercase mb-2">Event Title</label>
                    <input type="text" name="title" class="form-input w-full px-4 py-3 rounded-xl" placeholder="e.g. Coldplay Live">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="venue" class="form-input w-full px-4 py-3 rounded-xl" placeholder="e.g. D.Y. Patil Stadium">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="duration" class="form-input w-full px-4 py-3 rounded-xl" placeholder="e.g. 120">
                </div>
                
                <!-- Event Date -->
                <div>
                    <label class="block text-xs font-medium text-slate-500 uppercase mb-2">Event Date</label>
                    <input type="date" name="event_date" class="form-input w-full px-4 py-3 rounded-xl">
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" rows="4" class="form-input w-full px-4 py-3 rounded-xl" placeholder="Write a short description of the event..."></textarea>
                </div>
                ...
                <div class="sm:col-span-2 space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <p class="text-xs text-slate-400">Tweak the layout for this specific event. Default loaded from Master Layout.</p>
                    </div>
                ...
                <!-- Event Poster -->
                <div class="sm:col-span-2">
                    <label class="block text-xs font-medium text-slate-500 uppercase mb-2">Event Poster</label>
        ...
        $(document).ready(function() {
            ...
            $('#addEventForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        let errorMessage = xhr.responseJSON?.message || 'An error occurred while adding the event.';
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: errorMessage,
